    ...
    if (doc.exists) {
      ...
      document.getElementById("user-points").innerText = "Points: " + userData.points;
        if (userData.points >= 50){
          console.log("True")
          document.getElementById("50for2").style.display = "block";
          document.getElementById("50for2qr").innerHTML = ""
          var userId = "kGeopn4k0W2iItx";
          new QRCode(document.getElementById("50for2qr"), userId);
        }else{
          document.getElementById("50for2").style.display = "none";
        }
        if (userData.points >= 100){
          console.log("True")
          document.getElementById("100for5").style.display = "block";
          document.getElementById("100for5qr").innerHTML = ""
          var userId = "sY3fqm9kTeF6yiK";
          new QRCode(document.getElementById("100for5qr"), userId);
        }else{
          
          document.getElementById("100for5").style.display = "none";
        }
...
function signUp() {
  ...
  auth.createUserWithEmailAndPassword(email, password)
    ...
    .catch((error) => {
      const errorCode = error.code;
      const errorMessage = error.message;
      alert("Error: Please Try Again. Contact Owner If Error Persists!");
    });
}
